...
const coverageData: CoverageItem[] = [
  ...
  },
  {
    ...
    items: [
      'coverage.legal.item1',
      'coverage.legal.item2',
      'coverage.legal.item3',
      'coverage.legal.item4',
      'coverage.legal.item5',
    ],
  ...
  },
  {
    ...
    items: [
      'coverage.business.item1',
      'coverage.business.item2',
      'coverage.business.item3',
      'coverage.business.item4',
      'coverage.business.item5',
      'coverage.business.item6',
    ],
  ...
  },
  {
    ...
    items: [
      'coverage.extortion.item1',
      'coverage.extortion.item2',
      'coverage.extortion.item3',
      'coverage.extortion.item4',
    ],
  ...
  },
  {
    ...
    items: [
      'coverage.fraud.item1',
      'coverage.fraud.item2',
      'coverage.fraud.item3',
      'coverage.fraud.item4',
    ],
  ...
  },
  {
    ...
    items: [
      'coverage.prevention.item1',
      'coverage.prevention.item2',
      'coverage.prevention.item3',
      'coverage.prevention.item4',
      'coverage.prevention.item5',
    ],
...
export default function CoverageAccordion() {
  ...
  return (
    <section id="coverage" className="section-padding bg-slate-50">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">{t('coverage.title')}</h2>
        </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={cn('p-3 rounded-lg text-white', coverage.color)}>
                    {coverage.icon}
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg">{t(coverage.titleKey)}</h3>
                    <p className="text-sm text-muted-foreground">{t(coverage.subtitleKey)}</p>
                  </div>
                </div>
                <ChevronDown
                  className={cn(
                    'h-5 w-5 text-muted-foreground transition-transform duration-200',
                    openId === coverage.id && 'rotate-180'
                  )}
                />
              </button>
              ...
              <div
                className={cn(
                  ...
                  openId === coverage.id ? 'max-h-[1000px]' : 'max-h-0'
                )}
              >
                <div className="px-6 pb-6 pt-2 border-t border-border">
                  <p className="text-muted-foreground mb-6">{t(coverage.descriptionKey)}</p>

                  {/* Coverage Items */}
                  <div className="grid sm:grid-cols-2 gap-3 mb-6">
                    {coverage.items.map((itemKey, index) => (
                      <div key={index} className="flex items-start gap-2">
                        <Check className="h-5 w-5 text-[#00B050] shrink-0 mt-0.5" />
                  ...
                  {/* Example */}
                  <div className="bg-slate-50 rounded-lg p-4 border-l-4 border-[#00B050]">
