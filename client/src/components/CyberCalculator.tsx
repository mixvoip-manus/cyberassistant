...
const translations = {
  en: {
    ...
    assuranceDesc: 'Insurance Coverage by Foyer',
    ...
    assurEssentielDesc: 'Foyer covers 2 days emergency deployment',
    assurAdvanced: 'Advanced – 200€/year',
    assurAdvancedDesc: 'Foyer covers 4 days emergency deployment',
    assurPro: 'Pro – On request',
    assurProDesc: 'Foyer Cyber Pro full contract',
    // Advisory options
    ...
    incident5resp_assur: 'Foyer (CyberAssurance)',
    incident5resp_no: 'You – deployment costs at 800€/day',
    incident5hint_no: 'A typical incident takes 2-5 days = 1,600€ – 4,000€',
    incident5hint_essentiel: 'Foyer covers up to 2 days (1,600€)',
    incident5hint_advanced: 'Foyer covers up to 4 days (3,200€)',
    incident6: 'CNPD notification (72h deadline)',
    incident6resp_advis: 'Luxgap (CyberAdvisory)',
    incident6resp_assurpro: 'Foyer lawyer (CyberAssurance Pro)',
    ...
    assurServiceTitle: 'CyberAssurance (Foyer)',
    ...
    assurEssentielServiceDesc: 'Foyer covers the costs of 2 days Mixvoip emergency deployment (value: 1,600€).',
    assurAdvancedServiceDesc: 'Foyer covers the costs of 4 days Mixvoip emergency deployment (value: 3,200€).',
    assurProServiceDesc: 'Foyer Cyber Pro full insurance contract. Comprehensive cyber coverage including financial losses, business interruption, data recovery, and legal costs.',
  ...
  fr: {
    ...
    assuranceLabel: 'Mixvoip CyberAssurance',
    assuranceDesc: 'Couverture d\'assurance par Foyer',
    advisoryLabel: 'Mixvoip CyberAdvisory',
    ...
    assurEssentielDesc: 'Foyer couvre 2 jours de déploiement d\'urgence',
    assurAdvanced: 'Advanced – 200€/an',
    assurAdvancedDesc: 'Foyer couvre 4 jours de déploiement d\'urgence',
    assurPro: 'Pro – Sur demande',
    assurProDesc: 'Contrat complet Foyer Cyber Pro',
    ...
    incident5hint_essentiel: 'Foyer couvre jusqu\'à 2 jours (1 600€)',
    incident5hint_advanced: 'Foyer couvre jusqu\'à 4 jours (3 200€)',
    incident6: 'Notification CNPD (délai 72h)',
    incident6resp_advis: 'Luxgap (CyberAdvisory)',
    incident6resp_assurpro: 'Avocat Foyer (CyberAssurance Pro)',
    ...
    assurEssentielServiceDesc: 'Foyer couvre les coûts de 2 jours de déploiement d\'urgence Mixvoip (valeur : 1 600€).',
    assurAdvancedServiceDesc: 'Foyer couvre les coûts de 4 jours de déploiement d\'urgence Mixvoip (valeur : 3 200€).',
    assurProServiceDesc: 'Contrat complet Foyer Cyber Pro. Couverture cyber complète incluant pertes financières, interruption d\'activité, récupération de données et frais juridiques.',
  ...
  de: {
    ...
    assuranceLabel: 'Mixvoip CyberAssurance',
    assuranceDesc: 'Versicherungsschutz durch Foyer',
    advisoryLabel: 'Mixvoip CyberAdvisory',
    ...
    assurEssentielDesc: 'Foyer übernimmt 2 Tage Notfalleinsatz',
    assurAdvanced: 'Advanced – 200€/Jahr',
    assurAdvancedDesc: 'Foyer übernimmt 4 Tage Notfalleinsatz',
    assurPro: 'Pro – Auf Anfrage',
    assurProDesc: 'Foyer Cyber Pro Vollvertrag',
    ...
    incident5hint_essentiel: 'Foyer übernimmt bis zu 2 Tage (1.600€)',
    incident5hint_advanced: 'Foyer übernimmt bis zu 4 Tage (3.200€)',
    incident6: 'CNPD-Meldung (72h Frist)',
    incident6resp_advis: 'Luxgap (CyberAdvisory)',
    incident6resp_assurpro: 'Foyer Anwalt (CyberAssurance Pro)',
    ...
    assurEssentielServiceDesc: 'Foyer übernimmt die Kosten für 2 Tage Mixvoip-Notfalleinsatz (Wert: 1.600€).',
    assurAdvancedServiceDesc: 'Foyer übernimmt die Kosten für 4 Tage Mixvoip-Notfalleinsatz (Wert: 3.200€).',
    assurProServiceDesc: 'Foyer Cyber Pro Vollvertrag. Umfassender Cyber-Versicherungsschutz inkl. finanzielle Verluste, Betriebsunterbrechung, Datenwiederherstellung und Rechtskosten.',
