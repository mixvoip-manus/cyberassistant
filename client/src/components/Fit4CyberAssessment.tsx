...
const translations = {
  en: {
    ...
    eligible: 'Eligible for Cyber Suite',
    ...
    pricingTitle: 'Cyber Suite Pricing',
    ...
    basicNote: '*For Mixvoip customers with Fit4Cyber score ≥65%',
  ...
  fr: {
    ...
    eligible: 'Éligible pour Cyber Suite',
    ...
    pricingTitle: 'Tarifs Cyber Suite',
    ...
    basicNote: '*Pour les clients Mixvoip avec score Fit4Cyber ≥65%',
  ...
  de: {
    ...
    yourScore: 'Ihr Score',
    eligible: 'Berechtigt für Cyber Suite',
    ...
    pricingTitle: 'Cyber Suite Preise',
    ...
    basicNote: '*Für Mixvoip-Kunden mit Fit4Cyber-Score ≥65%',
...
export default function Fit4CyberAssessment() {
  ...
  const generatePDFReport = () => {
    ...
    doc.setFontSize(10);
    doc.setTextColor(isEligible ? greenColor[0] : 200, isEligible ? greenColor[1] : 150, isEligible ? greenColor[2] : 0);
    doc.text(isEligible ? 'ELIGIBLE for Cyber Suite' : 'Below 65% threshold - Improvement needed', 90, scoreBoxY + 25);
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.setFontSize(8);
      doc.setTextColor(grayColor[0], grayColor[1], grayColor[2]);
      doc.text('Generated by Mixvoip Cyber Suite | www.mixvoip.com | pberg@mixvoip.com', 105, 290, { align: 'center' });
  ...
  const handleSubmitContact = async (e: React.FormEvent, isFastTrack: boolean = false) => {
    ...
    const subject = encodeURIComponent(`${isFastTrack ? '[FAST-TRACK] ' : ''}Cyber Suite Anfrage - ${contactForm.company}`);
    
    let body = '';
    
    if (isFastTrack) {
      body = encodeURIComponent(
`FAST-TRACK ANFRAGE: Cyber Suite
=====================================
...
Gesendet von: Mixvoip Cyber Suite Website`
      );
    } else {
      ...
      body = encodeURIComponent(
`NEUE ANFRAGE: Cyber Suite Beratung
========================================
...
Assessment-Ergebnis:
- Score: ${scorePercentage}% (${isEligible ? 'Eligible für Cyber Suite' : 'Unter 65% Threshold'})
