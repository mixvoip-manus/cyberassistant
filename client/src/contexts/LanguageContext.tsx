...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'what.description2': 'Six integrated components work together: Mixvoip builds and rebuilds your IT, Mixvoip SLA maintains it, SOC as a Service monitors around the clock, CyberAssistance responds in emergencies, CyberAdvisory handles compliance and legal matters, and CyberAssurance covers the financial damage.',
  ...
  fr: {
    ...
    'what.description2': 'Six composants intégrés travaillent ensemble : Mixvoip construit et reconstruit votre IT, Mixvoip SLA l\'entretient, SOC as a Service surveille 24h/24, CyberAssistance intervient en cas d\'urgence, CyberAdvisory gère la conformité et le juridique, et CyberAssurance couvre les dommages financiers.',
  ...
  de: {
    ...
    'what.description2': 'Sechs integrierte Komponenten arbeiten zusammen: Mixvoip baut und repariert Ihre IT, Mixvoip SLA wartet sie, SOC as a Service überwacht rund um die Uhr, CyberAssistance reagiert im Notfall, CyberAdvisory kümmert sich um Compliance und Recht, und CyberAssurance deckt den finanziellen Schaden.',
